...
from typing import Union, Sequence, Iterable, Callable, Optional, Any, Awaitable
...
class MiddlewareList(list):
    ...
    def request(self) -> Sequence[RequestHandler]:
        ...
        """
        return tuple(m.request for m in self if hasattr(m, 'request'))
    ...
    def dispatch(self) -> Sequence[DispatchHandler]:
        ...
        """
        return tuple(m.request for m in self if hasattr(m, 'dispatch'))
    ...
    def handle_500(self) -> Sequence[Handle500Handler]:
        ...
        """
        return tuple(m.request for m in self if hasattr(m, 'handle_500'))
    ...
    def openapi(self) -> Sequence[OpenApiHandler]:
        ...
        """
        return tuple(m.request for m in self if hasattr(m, 'openapi'))
